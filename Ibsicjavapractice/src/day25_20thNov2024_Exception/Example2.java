...
//try block mai exception occured and handled by catch block(throwable e)
public class Example2 {
	...
	public static void main(String[] args) {
		...
		} catch (Throwable e) {//when you are not sure about exception type coming from try block use Throwable
